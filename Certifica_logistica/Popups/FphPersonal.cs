...
{
    public partial class FphPersonal : FpMaster
    {
        private DataSet _ds;
        public FphPersonal()
        {
...
// ReSharper disable once RedundantToStringCall
        ...
        private void FphPersonal_Load(object sender, EventArgs e)
        {
            TxtFiltro.Focus();
        }

        private void FphPersonal_SizeChanged(object sender, EventArgs e)
        {
            gridView1.BestFitColumns();
        }
    }
