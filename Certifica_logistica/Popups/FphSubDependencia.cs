...
{
    public partial class FphSubDependencia : FpMaster
    {
        private DataSet _ds;
        public FphSubDependencia()
        {
            InitializeComponent();
        }
...
// ReSharper disable once RedundantToStringCall
        ...
        private void FphSubDependencia_Load(object sender, EventArgs e)
        {
            TxtFiltro.Focus();
        }

        private void FphSubDependencia_SizeChanged(object sender, EventArgs e)
        {
            gridView1.BestFitColumns();
        }
